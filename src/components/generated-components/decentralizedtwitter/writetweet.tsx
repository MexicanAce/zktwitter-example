...
import { useDecentralizedTwitterWriteTweet } from "../../../generated";

const DecentralizedTwitterWriteTweetComponent = () => {
...
export default DecentralizedTwitterWriteTweetComponent;