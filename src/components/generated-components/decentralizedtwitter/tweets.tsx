...
import { useDecentralizedTwitterTweets } from "../../../generated";

const DecentralizedTwitterTweetsComponent = () => {
  
  /* Use this hook anywhere in your dapp to call this function! */

  const [functionArgs, setFunctionArgs] = useState([]);
  const { data, isLoading, isError, error } = useDecentralizedTwitterTweets({
    //@ts-ignore
    args: functionArgs,
    watch: true,
  });
...
export default DecentralizedTwitterTweetsComponent;